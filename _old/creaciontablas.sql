...
-- Tabla de Matriz de Permisos (Rol <-> Módulo)
-- Controla granularmente qué puede hacer cada rol en cada módulo.
CREATE TABLE permiso (
  id_permiso CHAR(36) PRIMARY KEY,
  id_rol CHAR(36) DEFAULT NULL, -- Opcional: Puede ser null si el permiso es de usuario
  id_usuario CHAR(36) DEFAULT NULL, -- Opcional: Especifico para un usuario
