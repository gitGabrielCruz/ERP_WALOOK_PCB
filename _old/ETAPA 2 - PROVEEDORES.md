...
| **RNF-04** | Consistencia visual | Diseño uniforme | Patrón Master-Detail consistente con Clientes |
...
CREATE TABLE proveedor (
    -- Identificación
    id_proveedor        VARCHAR(20) PRIMARY KEY,           -- PRV-00001, PRV-00002, etc.
    
    -- Datos principales
    rfc                 VARCHAR(12) UNIQUE NOT NULL,       -- RFC único (12 caracteres Moral)
    ...
    INDEX idx_condicion_pago (condicion_pago),
    
    -- Constraints
    CONSTRAINT chk_rfc_length CHECK (LENGTH(rfc) = 12)
);
```
