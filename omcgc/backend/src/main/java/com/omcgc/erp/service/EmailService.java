...
Ruta              : omcgc/backend/src/main/java/com/omcgc/erp/service/EmailService.java
...
1. RNF-04 (Notificaciones por Correo):
   - Construcción de sender dinámico.
   - Puntos de entrada para envío de correos de sistema y de prueba.
============================================================
*/
