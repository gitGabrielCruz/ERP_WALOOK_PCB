...
Ruta              : omcgc/backend/src/main/java/com/omcgc/erp/controller/SmtpController.java
...
Solo accesible para administradores y perfiles autorizados.

Trazabilidad y Mapeo Funcional:
------------------------------------------------------------
1. RNF-04 (Notificaciones por Correo):
   - Gestión de credenciales SMTP encriptadas.
   - Endpoint de prueba de conectividad y estado de configuración.
============================================================
*/
