...
Ruta              : omcgc/backend/src/main/java/com/omcgc/erp/service/BitacoraService.java
...
personal sea ilegible sin la llave maestra de la empresa.

Trazabilidad y Mapeo Funcional:
------------------------------------------------------------
1. RNF-01 (Auditoría y Privacidad):
   - Cifrado AES-256 de campos sensibles (Acción, IP, Detalles).
   - Integración con el motor de patrones de auditoría.
   - Soporte para descifrado en memoria durante consultas administrativas.
============================================================
*/
