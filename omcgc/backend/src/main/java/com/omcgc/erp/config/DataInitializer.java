...
Ruta              : backend/src/main/java/com/omcgc/erp/config/DataInitializer.java
...
Implementa el enfoque "Code-First Seeding" para:
1. Roles Estándar (ADMIN, CAJA, etc.)
2. Catálogo Oficial de 12 Módulos.
