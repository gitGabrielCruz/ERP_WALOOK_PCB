...
-- DROP DATABASE IF EXISTS db_omcgc_erp; -- COMENTADO PARA PROTEGER DATOS
-- CREATE DATABASE IF NOT EXISTS db_omcgc_erp ...
USE db_omcgc_erp; -- Asegura usar la BD correcta (o optica_erp según tu config)
